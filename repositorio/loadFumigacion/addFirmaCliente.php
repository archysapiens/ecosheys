							...
							<div class="tab-content">															
								<div role="tabpanel" class="tab-pane active" id="emailClient" style="height:280px;">
									<div class="form-group form-group-sm row" style="padding-top:50px">
										...
										<a id="NexTabCanvasFirmaClient" style="margin-top:120px;" href="#canvasTabFirmaClient" aria-controls="canvasTabFirmaClient" data-toggle="tab" class="btn btn-primary btn-md active" role="button">Siguiente &nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
									</div>
								</div>
									...
									if(RequestFirma==true){
										...
										setTimeout(function(){ 											
											if(TypeUser =='CLIENTE'){												
												...
												var hrefParamAddFirmaFpdf = "hrefRutaFpdf="+hrefRutaFpdfClient+"&hrefRutaFirma="+hrefRutaFirmaClient+"&TypeUser="+TypeUser+"&NoFolio="+FolioValidClient+"&sendSucursal="+sendSucursal+"&IdClientValid="+IdClientValid;
						...
						<script>
							function downloadCanvasFirmaClient(link, canvasId, filename, correoEnvio, dirTypeFumi, sucursal, TypeUser, IdUser) {
								...
								if(Trazados!='' && Trazados!=',' && Trazados!=',,' && Trazados!=',,,' && Trazados!=',,,,' && Trazados!=',,,,,' && Trazados!=',,,,,,'){										
									...
									xhr.open('POST','../../repositorio/loadFumigacion/canvasFirmaClient.php',true);
