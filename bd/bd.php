...
class DbCnnx {
    ...
    public function cnnxDB() {    
        ...
        if(!isset(self::$DBCnnx)) {
            ...
            $DatCnnx = parse_ini_file($_SERVER['DOCUMENT_ROOT'] .'/ecosheys2017/bd/ecosheys_cnx.ini'); 
            self::$DBCnnx = new mysqli($DatCnnx['servidor'],$DatCnnx['usuario'],$DatCnnx['password'],$DatCnnx['base_ecosheys']);
        }
	...
	public function queryReturnId($Consulta) {
        // Connect to the database
        $DBCnnx = $this->cnnxDB();
