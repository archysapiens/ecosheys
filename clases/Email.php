...
/**
		$sqlIdTables = "SELECT * FROM valid_modulo WHERE ID_VALID='$FOLIO' AND VALID='true' OR (VALID='false' AND TYPE_USER='CLIENTE') OR (VALID='listo' AND TYPE_USER='AddEmailEnvio')"; 
**/
		$sqlIdTables = "SELECT * FROM valid_modulo WHERE ID_VALID='$FOLIO' AND CORREO_ENVIO != 'raquelpastrana@telmexmail.com' AND CORREO_ENVIO != 'calidadcerbatex@cerbatex.com' AND VALID='true' OR (VALID='false' AND TYPE_USER='CLIENTE') OR (VALID='listo' AND TYPE_USER='AddEmailEnvio');"; 
