<?php
 ...
 class Extintores{
	...
	public function deleteTableNewOrdenT($POST){
		...
		@$Query1 ="DELETE FROM ordent_ext WHERE NO_FOLIO LIKE '$getNoFolioOT'"; @$db->query($Query1);
		@$Query2 ="DELETE FROM valid_modulo WHERE ID_VALID LIKE '$getNoFolioOT'"; @$db->query($Query2);
		@$Query3 ="DELETE FROM poliza_ext WHERE NO_FOLIO LIKE '$getNoFolioPG'"; @$db->query($Query3);
		@$Query4 ="DELETE FROM valid_modulo WHERE ID_VALID LIKE '$getNoFolioPG'"; @$db->query($Query4);
		@$Query5 ="DELETE FROM checklist_ext WHERE NO_FOLIO LIKE '$getNoFolioCL'"; @$db->query($Query5);
    }
