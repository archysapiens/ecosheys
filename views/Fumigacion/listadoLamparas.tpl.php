							...
							<div class="ibox float-e-margins" id="RegistroDeServicio">
								...
								<script type="text/javascript">
									$(document).ready(function () {
										...
										$("#jqGrid").jqGrid({
											// url: '../../repositorio/DataJson/DataFumigacion/InspeccionLamparas/dataReport.json',
											url: '../../repositorio/DataJson/DataFumigacion/listarJsonBlank.php?nomJson=dataReport&carpetJson=InspeccionLamparas',																					 
											editurl: 'lisLamparas.php',
											datatype: "json",
											colModel: [
												{
													label: "Acciones",
								...
								<script type="text/javascript">									
									...
									$("#txtnoCliente").keyup(function() {
										...
										var TypeReportFumi = "LAM"; // Inspección Lámparas		 
										// var JqGridUrlKeyUp ='../../repositorio/DataJson/DataFumigacion/InspeccionLamparas/dataReport.json';
										var JqGridUrlKeyUp ='../../repositorio/DataJson/DataFumigacion/listarJsonBlank.php?nomJson=dataReport&carpetJson=InspeccionLamparas';																											
										$('#jqGrid').setGridParam({ url: JqGridUrlKeyUp , editurl: 'lisLamparas.php', datatype: "json" }).trigger('reloadGrid');
										...
										$.ajax({
											...
											success: function(result) {	
												...
												if(result=='vacio'){
													...
													cadena = 'RL'+cadenaSucur+''+cadena+''+yyyy+''+mm+''+dd+''+pad(noCliente);
								...
								<script>				
									$( '#btnGuardar_Report_Fumi' ).click( function (event) {											
										...
										var dirTypeFumi = "InspeccionLamparas";
										var formCreatedReportInpecLamp = 'formCreatedReportInpecLamp';								  
										...
										$("#jqGrid tbody tr").each(function (index) 
										{
											...
											if(campo2!='' && ubicacion!='+ +'){
													...
													ubicacion = ubicacion.replace('+', '');														
													$.post( 'lisLamparas.php' , { formCreatedReportInpecLamp : formCreatedReportInpecLamp,noFolio:noFolio,fecha_service:fecha_service,noCliente:noCliente,horInicio:horInicio,horFinal:horFinal,
																			  id_object:id_object,ubicacion:ubicacion,mosquito:mosquito,mosca:mosca,palomilla:palomilla,escarabajo:escarabajo,limpieza:limpieza,estatus_object:estatus_object,obser_object:obser_object,Obser:Obser,responsable:responsable,tecnico:tecnico,administracion:administracion,nomClient:nomClient,valid:'table'} );														
										...
										if(banderaNextStep==true){
											$.post( 'lisLamparas.php' , { GererateJsonRL : 'GererateJsonRL', CamposGrid:CamposGrid , noCliente:noCliente, sucursal:sucursal } );
												...
												var hrefUrlReportFpdf = '../../repositorio/fpdf/ReporConsuInspecLamp.php?';
											...
											if(VALID=='false'){
												var GetNoFolioReport = $( '.txtnoFolio' ).val(),
													NomOfReport = 'Reporte de Inspección de Lámparas',
													GetnoClienteReport = $( '.txtnoCliente' ).val();
												var nextValidEmailEnvio = 'nextValidEmailEnvio';									
												
													// Enviar correo al tecnico para validar											
													$.post( 'lisLamparas.php' , { nextValidEmailEnvio : nextValidEmailEnvio,GetNoFolioReport:GetNoFolioReport,GetnoClienteReport:GetnoClienteReport,RutaPdfReport:RutaPdfReport,NomOfReport:NomOfReport },
													function ( exito ){													
								...
								<script type="text/javascript">
									$("#addEmailEnvioButton").click(function(event) {
										...
										$('.text-info-addEmailEnvio').html('');										
											...
											$.post( 'lisLamparas.php' , { formAddEmailEnvio : formAddEmailEnvio,AddEmailEnvio:AddEmailEnvio,GetNoFolio:GetNoFolio,GetnoCliente:GetnoCliente },
											function ( exito ){													
