							...
							<div class="ibox float-e-margins" id="RegistroDeServicio">
								...
								<script type="text/javascript">
									$(document).ready(function () {
										...
										$("#jqGrid").jqGrid({
											// url: '../../repositorio/DataJson/DataFumigacion/ReportesMoscas/dataReport.json',
											url: '../../repositorio/DataJson/DataFumigacion/listarJsonBlank.php?nomJson=dataReport&carpetJson=ReportesMoscas',
											editurl: 'conMoscas.php',
											datatype: "json",
											colModel: [
												{
													label: "Acciones",
								...
								<script type="text/javascript">
									...
									$("#txtnoCliente").keyup(function() {
										...
										var TypeReportFumi = "MOS"; // MOSCAS
										// var JqGridUrlKeyUp ='../../repositorio/DataJson/DataFumigacion/ReportesMoscas/dataReport.json';
										var JqGridUrlKeyUp ='../../repositorio/DataJson/DataFumigacion/listarJsonBlank.php?nomJson=dataReport&carpetJson=ReportesMoscas';
										$('#jqGrid').setGridParam({ url: JqGridUrlKeyUp , editurl: 'conMoscas.php', datatype: "json" }).trigger('reloadGrid');
										...
										$.ajax({
											...
											success: function(result) {	
												...
												if(result=='vacio'){
													...
													cadena = 'RM'+cadenaSucur+''+cadena+''+yyyy+''+mm+''+dd+''+pad(noCliente);
								...
								<script>					
									$( '#btnGuardar_Report_Fumi' ).click( function (event) {																			  									
										...
										var dirTypeFumi = "ReportesMoscas";										
										var formCreatedReportMoscas = 'formCreatedReportMoscas';																			  
										...
										$("#jqGrid tbody tr").each(function (index) 
										{
											...
											if(campo2!='' && ubicacion!='+ +'){
													...
													ubicacion = ubicacion.replace('+', '');														
													$.post( 'conMoscas.php' , { formCreatedReportMoscas : formCreatedReportMoscas,noFolio:noFolio,fecha_service:fecha_service,noCliente:noCliente,horInicio:horInicio,horFinal:horFinal,
										...
										if(banderaNextStep==true){
											$.post( 'conMoscas.php' , { GererateJson : 'GererateJson', CamposGrid:CamposGrid , noCliente:noCliente, sucursal:sucursal } );
												...
												var hrefUrlReportFpdf = '../../repositorio/fpdf/ReporConsuMoscas.php?';
											...
											if(VALID=='false'){
												var GetNoFolioReport = $( '.txtnoFolio' ).val(),
													NomOfReport = 'Reporte de Consumo de Moscas',
													GetnoClienteReport = $( '.txtnoCliente' ).val();
												var nextValidEmailEnvio = 'nextValidEmailEnvio';									
												
													// Enviar correo al tecnico para validar											
													$.post( 'conMoscas.php' , { nextValidEmailEnvio : nextValidEmailEnvio,GetNoFolioReport:GetNoFolioReport,GetnoClienteReport:GetnoClienteReport,RutaPdfReport:RutaPdfReport,NomOfReport:NomOfReport },
													function ( exito ){													
								...
								<script type="text/javascript">
									$("#addEmailEnvioButton").click(function(event) {
										...
										$('.text-info-addEmailEnvio').html('');										
											...
											$.post( 'conMoscas.php' , { formAddEmailEnvio : formAddEmailEnvio,AddEmailEnvio:AddEmailEnvio,GetNoFolio:GetNoFolio,GetnoCliente:GetnoCliente },
											function ( exito ){													
